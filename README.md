...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/MonadABXY/tangba-font@main/tangba.css" />
```

### `@import`

```css
@import url("https://cdn.jsdelivr.net/gh/MonadABXY/tangba-font@main/tangba.css");
```
